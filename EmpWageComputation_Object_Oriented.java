	...
	public void empComputeWage()
	{
        ...
        public int empComputeWage(CompanyEmpWage companyEmpWage)
        {
                ...
                while(empTotalHrs < companyEmpWage.maxWorkingHrs && totalWorkingDays < companyEmpWage.numberOfWorkingDays)
                {
                        ...
                        System.out.println("Emlpoyee's Daily Hours for Day " + totalWorkingDays + " in " + companyEmpWage.companyName + ": " + empDailyHrs);
                ...
                System.out.println();
                System.out.println();
                System.out.println("Emlpoyee's Total Hours in " + companyEmpWage.companyName + ": "  + empTotalHrs);
